...
const AgreementTxt = () => {
  return (
    <>
      ...
      <ul>
        <li>Обработка данных для регистрации на мероприятия ОЦ &quot;Персей&quot;</li>
      </ul>
      <p>
      ...
      <p>
        ОЦ &quot;Персей&quot; обязуется не передавать полученные персональные
      ...
      <ul>
        ...
        <li>
          Стратегическим партнерам, которые работают с ОЦ &quot;Персей&quot; для
          предоставления продуктов и услуг, или тем из них, которые
          помогают ОЦ &quot;Персей&quot; реализовывать продукты и услуги
      ...
      <p>
        ОЦ &quot;Персей&quot; оставляет за собой право вносить изменения
